 ...
 * 
 *         Singleton-Class 
 *         - to initialize Gate and the configuration 
 *         - to initialize Log4J 
 *         - Later: to initialize Hibernate
 */
...
public class GateInitSingleton {
	 ...
	 * if an error orrcurs, the application end with exitcode -1;
	 * 
	 */
 ...
 */	
 ...
 /**
 * Executes th reset application on document in order to delete 
